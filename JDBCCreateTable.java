...
public class JDBCCreateTable{
	...
	static String userid="srikanth", password = "123";
	static String url = "jdbc:mysql://localhost:3306/sayantan";	// String url = "jdbc:mySubprotocol:myDataSource"; ?
	...
	public static Connection getConnection()
	{
		...
		try {
			Class.forName("com.mysql.jdbc.Driver");	//Class.forName("sun.jdbc.odbc.JdbcOdbcDriver"); ?
